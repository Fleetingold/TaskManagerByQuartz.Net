...
namespace Quartz.Net_RemoteServer.Events
{
    ...
    public abstract class SubjectBase
    {
        ...
        protected Task NotifyAsync(JobExcutedCallBackModel jobExcutedCallBackModel)
        {
            return Task.Run(()=> _jobExecutedCallBack.BeginInvoke(jobExcutedCallBackModel, null, null));
        }
